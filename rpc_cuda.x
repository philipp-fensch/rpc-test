...
/* RUNTIME API */
        ...
        int_result   CUDA_DEVICE_GET_CACHE_CONFIG()                 = 104;
        ...
        int_result   CUDA_DEVICE_GET_SHARED_MEM_CONFIG()            = 109;
        dint_result  CUDA_DEVICE_GET_STREAM_PRIORITY_RANGE()        = 110;
        u64_result   CUDA_DEVICE_GET_TEXTURE_LMW(cuda_channel_format_desc,
                          int)                                          = 111;
        int          CUDA_DEVICE_RESET()                            = 112;
        ...
        int          CUDA_DEVICE_SYNCHRONIZE()                      = 116;
        int_result   CUDA_GET_DEVICE()                              = 117;
        int_result   CUDA_GET_DEVICE_COUNT()                        = 118;
        int_result   CUDA_GET_DEVICE_FLAGS()                        = 119;
        ...
        int          CUDA_GET_LAST_ERROR()                          = 142;
        int          CUDA_PEEK_AT_LAST_ERROR()                      = 143;
        /* ### Stream Management ### */
        int          CUDA_CTX_RESET_PERSISTING_L2CACHE()            = 250;
        ...
        ptr_result   CUDA_STREAM_CREATE()                           = 255;
        ...
        /* ### Event Management ### */
        ptr_result   CUDA_EVENT_CREATE()                            = 280;
        ...
        dsz_result   CUDA_MEM_GET_INFO()                            = 423;
        ...
        /* ### Surface Object Management ### */
            /* NOT IMPLEMENTED */
        /* ### Version Management ### */
        int_result   CUDA_DRIVER_GET_VERSION()                      = 510;
        int_result   CUDA_RUNTIME_GET_VERSION()                     = 511;
        /* ### Graph Management ### */
            /* NOT IMPLEMENTED */
        /* ### Profiler Control ### */
            /* NOT IMPLEMENTED */
        /* DRIVER API */
        int_result  rpc_cuDeviceGetCount()                          = 1002;
        int         rpc_cuInit(int)                                     = 1003;
        int_result  rpc_cuDriverGetVersion()                        = 1004;
        ...
        ptr_result  rpc_cuCtxGetCurrent()                           = 1010;
        ...
        ptr_result  rpc_cuGetExportTable(rpc_uuid)                 = 1014;
        ptr_result  rpc_cuMemAlloc(uint64_t)                            = 1015;
        int_result  rpc_cuCtxGetDevice()                            = 1016;
        ...
        ptr_result  rpc_hidden_get_module(uint64_t, uint64_t,
                                          uint64_t, int)      = 1105;
        ptr_result  rpc_hidden_1_1()                                = 1111;
        void        rpc_hidden_1_3(uint64_t, uint64_t)                  = 1113;
        ptr_result  rpc_hidden_1_5()                                = 1115;
        ...
        /* CUSOLVER API */
        ptr_result  rpc_cusolverDnCreate()                          = 2001;
